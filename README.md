About flask-potion-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask-potion-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/biosustain/potion
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5475&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask-potion-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask-potion` can be installed with `conda`:
...
```
mamba install flask-potion
```

It is possible to list all of the versions of `flask-potion` available on your platform with `conda`:
...
```
mamba search flask-potion --channel conda-forge
```
...
mamba repoquery search flask-potion --channel conda-forge

# List packages depending on `flask-potion`:
mamba repoquery whoneeds flask-potion --channel conda-forge

# List dependencies of `flask-potion`:
mamba repoquery depends flask-potion --channel conda-forge
```
